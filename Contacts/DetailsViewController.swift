...
class DetailsViewController: UIViewController, UITextFieldDelegate {
    ...
    /*
     ...
     TODO: Figure out why 'isCool' is not showing.  Clean up ContactsTableViewController to show other vars 
     
     
     Condense statement below to understand Optionals for UIViewControllers
    ...
    @IBAction func coolValueChanged(_ sender: Any) {
        contact?.cool = coolSwitch.isOn
    }
